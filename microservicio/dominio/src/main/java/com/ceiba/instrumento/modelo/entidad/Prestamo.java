...
public class Prestamo implements Serializable {
    ...
    private static final String SE_DEBE_INGRESAR_LA_FECHA_ULTIMO_PAGO = "Se debe ingresar la fecha de ultimo pago";
    ...
    public Prestamo(Long id, String tipo, String nombre, Double valorPrestamo, LocalDate fechaPrestamo, LocalDate fechaUltimoPago, String idUsuario) {
        ...
        validarObligatorio(fechaUltimoPago, SE_DEBE_INGRESAR_LA_FECHA_ULTIMO_PAGO);
